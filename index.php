                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="proses_login.php">
                                        <div class="form-group">
                                            <input name="nik" require type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Masukan NIK Anda...">
                                        </div>
                                        <div class="form-group">
                                            <input name="nama_lengkap" require type="text" class="form-control form-control-user"
                                        ...
                                        <a href="register.php" class="btn btn-facebook btn-user btn-block">
                                             Belum Punya Akun? Klik disini<i class="fa fa-arrow-right fa-fw"></i>
                                        </a>
                                    </form>
                                </div>
                            </div>
